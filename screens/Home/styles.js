...
export const HomeStyles = styled.View`
`;
...
export const ButtonStyled = styled(Button).attrs({
  ...
  margin-left: ${props => props.accessibilityLabel === 'inst' ? '25px' : props.accessibilityLabel === 'hist' ? '25px' : '0'};
`;
...
export const CardMenuStyled = styled(Card).attrs({})`
    color: black;
    height: 100%;
`;
